import { KNOWN_TYPES, DEFAULT_PARAM_TYPE, DEFAULT_RETURN_TYPE, } from './constants.js';
...
function getType(type, context, useExactType) {
    const defaultType = context === 'return' ? DEFAULT_RETURN_TYPE : DEFAULT_PARAM_TYPE;
...
function parseUnionType(type, context, useExactType) {
 ...
 */
function parseFunctionType(type, context) {
    // Remove whitespace
    type = type.trim();
